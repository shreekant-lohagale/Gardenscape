...
import styles from "./plant-button.module.css";
import { cn } from "@/lib/utils";

interface PlantButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
    text?: string;
}

export const PlantButton = ({ text = "Plant based", className, ...props }: PlantButtonProps) => {
    return (
